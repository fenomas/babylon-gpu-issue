...
export function initRegistration(noa) {
    ...
    // object block mesh
    var mesh = MeshBuilder.CreateBox('post', { size: 1 }, scene)
    ...
    var make = (s) => {
        ...
        testMat.diffuseTexture = new Texture('textures/' + s + '.png', scene)
        testMat.diffuseTexture.hasAlpha = true

        var testMesh = MeshBuilder.CreatePlane('cross:' + s, { size: 1 }, scene)
